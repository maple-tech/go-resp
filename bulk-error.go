...
func (e *BulkError) UnmarshalRESP3(src []byte) error {
...
func (e *BulkError) UnmarshalRESP(src []byte, ver Version) error {
	if ver == Version2 {
		return errors.New("bulk error is not available in RESP 2")
	}
	return e.UnmarshalRESP3(src)
}

func (e BulkError) MarshalRESP3() ([]byte, error) {
	buf := bytes.Buffer{}
...
func (e BulkError) MarshalRESP(ver Version) ([]byte, error) {
	if ver == Version2 {
		return nil, errors.New("bulk error is not available in RESP 2")
	}
	return e.MarshalRESP3()
}
